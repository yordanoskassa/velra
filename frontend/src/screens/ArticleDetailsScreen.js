...
const ArticleDetailsScreen = ({ route, navigation }) => {
  ...
  // ========== DEBUG SETTINGS ==========
  // Force subscription to false for testing blur ovelrays
  const isSubscribed = IS_DEBUG_MODE ? !FORCE_FREE_USER : isUserSubscribed;
  
  // State to manage insight ovelrays and unlock attempts
  const [insightOvelrays, setInsightOvelrays] = useState({});
  ...
  // Animation for the blur ovelray
  ...
  // Simplified ovelray implementation matching your example
  const OvelrayExample = () => (
    <View style={styles.articleContentWrapper}>
      {/* Article Content */}
      <Text style={styles.snippet}>{article.content}</Text>
      
      {/* Ovelray Implementation */}
      <View style={styles.ovelrayContainer}>
        <ImageBackground
          source={{ uri: article.urlToImage }}
          style={styles.imageBackground}
        >
          <View style={styles.ovelray}>
            <Text style={styles.ovelrayIcon}>🔓</Text>
            <Text style={styles.ovelrayText}>Tap to unlock premium content</Text>
          </View>
        </ImageBackground>
      </View>
    </View>
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.scrollView} contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.articleContainer}>
          ...
          {/* Cover article content with premium ovelray */}
          <View style={styles.articleContentWrapper}>
            <Text style={styles.snippet}>{article.content || 'No content available'}</Text>
            <Text style={styles.description}>{article.description}</Text>
            
            {/* Premium ovelray for article content */}
