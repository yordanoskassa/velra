...
const WeeklyInsightsBlock = () => {
  ...
  const handleViewMore = () => {
    ...
    if (isSubscribed) {
      ...
      // Show the real velra PRO paywall when non-subscribed user tries to access premium content
      console.log("Non-subscribed user attempting to view full weekly report, showing velra PRO paywall");
      showCustomPaywall();
    }
  };
  ...
  const handleSubscribe = () => {
    if (!user) {
      ...
      // Show the real velra PRO paywall
      showCustomPaywall();
    }
  };
  ...
  return (
    <TouchableOpacity 
      ...
      activeOpacity={0.8}
      onPress={() => {
        console.log("Non-subscribed user clicked weekly insights, showing velra PRO paywall");
        showCustomPaywall();
      }}
    >
